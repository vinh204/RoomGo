...
public final class SessionManager {
    ...
    private static final String KEY_IS_LOGGED_IN = "is_logged_in", KEY_USER_EMAIL = "user_email", KEY_USER_NAME = "user_name";
    ...
    public void saveSession(long userId, @Nullable String mongoUserId, String email, String name) {
        prefs.edit().putLong(KEY_USER_ID, userId).putString(KEY_MONGO_USER_ID, mongoUserId)
            .putBoolean(KEY_IS_LOGGED_IN, true).putString(KEY_USER_EMAIL, email).putString(KEY_USER_NAME, name).apply();
    }
    public long getUserId() { return prefs.getLong(KEY_USER_ID, -1L); }
    @Nullable public String getMongoUserId() { return prefs.getString(KEY_MONGO_USER_ID, null); }
    ...
    @Nullable public String getFullName() { return getUserName(); }
    public boolean isLoggedIn() { return prefs.getBoolean(KEY_IS_LOGGED_IN, false) && getUserId() != -1L; }
