...
public class User {
  ...
  public User withId(long v) {
    return new User(v, email, phone, password, fullName, createdAt);
  }

  public User updated(String n, String e, String p, String pass) {
    return new User(id, e, p, pass, n, createdAt);
  }

  public User withPassword(String pass) {
    return new User(id, email, phone, pass, fullName, createdAt);
  }

  public User withNamePassword(String n, String pass) {
    return new User(id, email, phone, pass, n, createdAt);
  }
}
